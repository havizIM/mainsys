...
const profileController = ((SET, UI) => {
    ...
    const _fetchProfile = TOKEN => {
        $.ajax({
            ...
            success: ({ results }) => {
                $('#profile_photo').attr('src', results.engineer.photo === null ? `${SET.baseURL()}assets/images/user.png` : `${SET.apiURL()}engineer/file/${results.engineer.photo}`)
                $('#profile_name').text(results.engineer.full_name)
                $('#profile_phone').text(SET.replaceNull(results.engineer.phone))
                $('#profile_address').text(SET.replaceNull(results.engineer.address))
                $('#profile_email').text(SET.replaceNull(results.email))
                $('#profile_city').text(SET.replaceNull(results.engineer.city.city))
                $('#profile_province').text(SET.replaceNull(results.engineer.province.province))
