...
const profileController = ((SET, UI) => {
    ...
    const _fetchProfile = TOKEN => {
        $.ajax({
            ...
            success: ({ results }) => {
                $('#profile_photo').attr('src', results.administrator.photo === null ? `${SET.baseURL()}assets/images/user.png` : `${SET.apiURL()}administrator/file/${results.administrator.photo}`)
                $('#profile_name').text(results.administrator.full_name)
                $('#profile_roles').text(results.administrator.level)
                $('#profile_phone').text(SET.replaceNull(results.administrator.phone))
                $('#profile_address').text(SET.replaceNull(results.administrator.address))
                $('#profile_email').text(SET.replaceNull(results.email))
                $('#profile_city').text(SET.replaceNull(results.administrator.city.city))
                $('#profile_province').text(SET.replaceNull(results.administrator.province.province))
