                                    ...
                                    <tr>
                                        ...
                                        <td class="w-50 text-right">
                                            ${data.schedule.building !== null ? `
                                                <address>
                                                    <h3>To</h3>
                                                    <h4 class="font-bold"><a href="#/partner/${data.schedule.building.partner.id}">${SET.replaceNull(data.schedule.building.partner.partner_name)}</a></h4>

                                                    <p><b><i class="mdi mdi-album"></i> Building :</b> <a href="#/partner/building/${data.schedule.building.id}">${data.schedule.building.building_code} - ${data.schedule.building.building_name}</a></p>
            ...
            const table = $('#t_corrective_report').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            return `
                                <a href="#/partner/equipment/${row.equipment.id}">${row.equipment.sku} - ${row.equipment.equipment_name}</a>
                            `;
                        }
                    },
                    {
