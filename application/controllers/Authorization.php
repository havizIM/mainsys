...
class Authorization extends CI_Controller {
	...
	public function authenticate()
	{
		...
		if($response->status == false){
			...
			if($response->data->roles == 'ADMINISTRATOR'){
				$payload['information'] = $response->data->administrator;
			} elseif($response->data->roles == 'ENGINEER'){
				$payload['information'] = $response->data->engineer;
			} else {
				$payload['information'] = $response->data->partner_user;
			}
