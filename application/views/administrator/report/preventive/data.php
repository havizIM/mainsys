<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Preventive Report</h4>
        </div>
            ...
            <div class="d-flex align-items-center justify-content-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Preventive Report</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table" id="t_preventive_report" style="width: 100%">
                            <thead>
                                <tr>
                                    <th>Report Number</th>
                                    <th>Date</th>
...
<script type="module">
    import preventiveReportController from '<?= base_url() ?>src/administrator/modules/preventive_report.js';
    preventiveReportController.data('<?= $this->session->userdata('api_token') ?>')
</script>