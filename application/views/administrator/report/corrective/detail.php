<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Detail Corrective Report</h4>
        </div>
...
<script type="module">
    import correctiveReportController from '<?= base_url() ?>src/administrator/modules/corrective_report.js';
    correctiveReportController.detail('<?= $this->session->userdata('api_token') ?>', <?= $id ?>)
</script>