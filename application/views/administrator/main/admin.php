...
<head>
    ...
    <title>MainSys | <?= $this->session->userdata('roles') ?></title>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/libs/bootstrap-duallistbox/dist/bootstrap-duallistbox.css">
...
<body>
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="<?= $this->session->userdata('information')->photo === null ? base_url('assets/images/user.png') : $this->config->item('api_url').'administrator/file/'.$this->session->userdata('information')->photo ?>" alt="user" class="rounded-circle" width="40" height="40">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    <div class="">
                                        <img src="<?= $this->session->userdata('information')->photo === null ? base_url('assets/images/user.png') : $this->config->item('api_url').'administrator/file/'.$this->session->userdata('information')->photo ?>" alt="user" class="rounded-circle" width="60" height="60">
                                    </div>
                                    <div class="m-l-10">
                                        <h4 class="m-b-0"><?= $this->session->userdata('information')->full_name ?></h4>
                                        <p class=" m-b-0">Level : <?= $this->session->userdata('information')->level ?></p>
                                    </div>
                                </div>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="far fa-list-alt"></i><span class="hide-menu">Master</span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item"><a href="#/administrator" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Administrator</span></a></li>
                                <li class="sidebar-item"><a href="#/engineer" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Engineer</span></a></li>
                                <li class="sidebar-item"><a href="#/partner" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Partner</span></a></li>
                            </ul>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="#/work_order" aria-expanded="false"><i class="mdi mdi-checkbox-multiple-blank-outline"></i><span class="hide-menu">Work Order</span></a></li>
    ...
    <script src="<?= base_url() ?>assets/libs/bootstrap-duallistbox/dist/jquery.bootstrap-duallistbox.js"></script>


    <script src="<?= base_url() ?>src/setting.js"></script>
    <script src="<?= base_url() ?>src/administrator/main.js"></script>
    <script>
