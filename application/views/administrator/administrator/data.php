                ...
                <div class="card-body">
                    <div class="d-flex flex-row">
                        ...
                        <div class="m-l-10 align-self-center">
                            ...
                            <span class="text-muted">Total Administrator</span>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table" id="t_administrator" style="width: 100%">
                            <thead>
                                <tr>
                                    <th>Full Name</th>
                                    <th>Address</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Filter Administrator</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="col-4-filter">Level</label>
                        <input id="col-4-filter" type="text" class="form-control filter-data" data-column="4" placeholder="Search Level">
                    </div>
                    <div class="form-group">
                        <label for="col-5-filter">Status</label>
                        <input id="col-5-filter" type="text" class="form-control filter-data" data-column="5" placeholder="Search Status">
                    </div>
                </div>
...
<script type="module">
    ...
    administratorController.data('<?= $this->session->userdata('api_token') ?>')
</script>