<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Detail Partner User</h4>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Delete Partner User</h4>
...
<script type="module">
    ...
    partnerController.detailPartnerUser('<?= $this->session->userdata('api_token') ?>', <?= $id ?>)
</script>