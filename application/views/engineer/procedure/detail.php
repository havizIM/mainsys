<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Detail Procedure</h4>
        </div>
...
<script type="module">
    import procedureController from '<?= base_url() ?>src/engineer/modules/procedure.js';
    procedureController.detail('<?= $this->session->userdata('api_token') ?>', <?= $id ?>)
</script>