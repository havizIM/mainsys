<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Detail Work Order</h4>
        </div>
...
<script type="module">
    import workOrderController from '<?= base_url() ?>src/engineer/modules/work_order.js';
    workOrderController.detail('<?= $this->session->userdata('api_token') ?>', <?= $id ?>)
</script>