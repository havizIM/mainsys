<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Detail Equipment</h4>
        </div>
...
<script type="module">
    import equipmentControoller from '<?= base_url() ?>src/engineer/modules/equipment.js';
    equipmentControoller.detail('<?= $this->session->userdata('api_token') ?>', <?= $id ?>)
</script>