<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Detail Building</h4>
        </div>
...
<script type="module">
    import buildingController from '<?= base_url() ?>src/engineer/modules/building.js';
    buildingController.detail('<?= $this->session->userdata('api_token') ?>', <?= $id ?>)
</script>