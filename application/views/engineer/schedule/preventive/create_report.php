<div class="page-breadcrumb">
    <div class="row">
        <div class="col-lg-5 col-12 align-self-center">
            <h4 class="page-title">Create Preventive Report</h4>
        </div>
            ...
            <div class="d-flex align-items-center justify-content-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#/preventive_report">Preventive Report</a>
                        </li>
...
<script type="module">
    ...
    preventiveReportController.add('<?= $this->session->userdata('api_token') ?>', <?= $id_schedule ?>, <?= $id_equipment ?>)
</script>