<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Preventive Schedule</h4>
        </div>
            ...
            <div class="d-flex align-items-center justify-content-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Preventive Schedule</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane p-20 active" id="table" role="tabpanel">
                           <div class="table-responsive">
                                <table class="table" id="t_preventive_schedule" style="width: 100%">
                                    <thead>
                                        <tr>
                                            <th>Building</th>
                                            <th>Date</th>
                        ...
                        <div class="tab-pane p-20" id="calendar" role="tabpanel">
                            <div id="preventive_calendar"></div>
                        </div>
                    </div>
...
<form id="form_delete">
    <div id="modal_delete" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Delete Preventive Schedule</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
...
<script type="module">
    import preventiveScheduleController from '<?= base_url() ?>src/engineer/modules/preventive_schedule.js';
    preventiveScheduleController.data('<?= $this->session->userdata('api_token') ?>')
</script>