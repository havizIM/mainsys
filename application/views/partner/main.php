...
<body>
                    ...
                    <div class="navbar-brand">
                        <a href="index.html" class="logo">
                            ...
                            <span class="logo-text">
                                <img src="<?= base_url() ?>assets/images/logo-text-dark.png" style="width: 90%" alt="homepage" class="dark-logo" />
                                <img src="<?= base_url() ?>assets/images/logo-text-light.png" style="width: 90%" class="light-logo" alt="homepage" />
                            </span>
                        </a>
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="<?= $this->session->userdata('information')->partner->logo === null ? base_url('assets/images/user.png') : $this->config->item('api_url').'partner/file/'.$this->session->userdata('information')->partner->logo ?>" alt="user" class="rounded-circle" width="40" height="40">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    <div class="">
                                        <img src="<?= $this->session->userdata('information')->partner->logo === null ? base_url('assets/images/user.png') : $this->config->item('api_url').'partner/file/'.$this->session->userdata('information')->partner->logo ?>" alt="user" class="rounded-circle" width="60" height="60">
                                    </div>
                                    <div class="m-l-10">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="far fa-list-alt"></i><span class="hide-menu">Master</span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"><a href="#/building" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Building</span></a></li>
                                <li class="sidebar-item"><a href="#/procedure" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Procedure</span></a></li>
                                <li class="sidebar-item"><a href="#/equipment" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Equipment</span></a></li>
                            </ul>
                        </li>
    ...
    <script src="<?= base_url() ?>dist/js/app.init.iconbar.js"></script>
    ...
    <script src="<?= base_url() ?>src/partner/main.js"></script>
    <script>
