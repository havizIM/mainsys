...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-4 col-xlg-3 col-md-5">
            <div class="card">
                <div class="card-body">
                    <center class="m-t-30"> <img id="profile_photo" class="rounded-circle" width="150" height="150" />
                        <h4 class="card-title m-t-10" id="profile_name">...</h4>
                        <h6 class="card-subtitle" id="profile_position">...</h6>
                    </center>
                </div>
                ...
                <div class="card-body">
                    <h4 class="card-title"><u>Partner Details</u></h4>

                    <small class="text-muted">Partner Name</small>
                    <h6 id="partner_name">...</h6>
                    
                    <small class="text-muted p-t-30 db">Phone</small>
                    <h6 id="partner_phone">...</h6>

                    <small class="text-muted p-t-30 db">Fax</small>
                    <h6 id="partner_fax">...</h6>

                    <small class="text-muted p-t-30 db">Handphone</small>
                    <h6 id="partner_handphone">...</h6>

                    <small class="text-muted p-t-30 db">Email</small>
                    <h6 id="partner_email">...</h6>

                    <small class="text-muted p-t-30 db">Address</small>
                    <h6 id="partner_address">...</h6>

                    <small class="text-muted p-t-30 db">City</small>
                    <h6 id="partner_city">...</h6>

                    <small class="text-muted p-t-30 db">Province</small>
                    <h6 id="partner_province">...</h6>
                </div>
...
<script type="module">
    import profileController from '<?= base_url() ?>src/partner/modules/profile.js';
